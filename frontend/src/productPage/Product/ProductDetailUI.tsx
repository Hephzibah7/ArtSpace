      ...
      transition={slow}
         className='p-5'>
          ...
          <div className='mt-3 flex gap-3'>
            <div className='bg-rose-400 p-2 rounded-2xl text-sm '>Free Shipping </div>
            <div className='bg-rose-400 p-2  rounded-2xl text-sm '>Fast Delievery </div>
            <div className='bg-rose-400 p-2  rounded-2xl text-sm '>Refund Guarenteed </div>
          </div>
          <hr className='mt-3 border border-rose-400'></hr>
          ...
          <hr className='mt-2 border border-rose-400'></hr>
          {selected == "description" && (<div className=' p-5'>

            <div className='bg-rose-400 p-4 rounded  text-sm'>
            ...
            <div className='mt-5'>
              ...
              <div className='flex gap-4 mt-2'>
                <div className='bg-rose-400 rounded-xl p-5 pl-10 pr-10 cursor-pointer '><span></span>1 Piece</div>
                <div className='bg-rose-400 rounded-xl p-5 pl-10 pr-10 cursor-pointer '><span></span>2 Piece</div>
                <div className='bg-rose-400 rounded-xl p-5 pl-10 pr-10 cursor-pointer '><span></span>3 Piece</div>
              </div>
            </div>
            <div className='mt-5'>
          ...
          {selected == "artist" && (
            <div className='mt-2 p-5'>
              ...
              <div className='mt-2 bg-rose-400 rounded p-5 italic'>
